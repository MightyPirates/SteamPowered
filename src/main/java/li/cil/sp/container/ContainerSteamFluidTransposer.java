...
public class ContainerSteamFluidTransposer extends Container {
    protected TileEntitySteamFluidTransposer tileEntity;
    private final static int PLAYER_SLOTS = 36;
    private final static int BLOCK_SLOTS = 2;

    public ContainerSteamFluidTransposer(InventoryPlayer inventoryPlayer, TileEntitySteamFluidTransposer te) {
        tileEntity = te;
